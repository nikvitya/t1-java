...
public class LogAspect {
    ...
    @Before("@annotation(ru.t1.java.general.annotation.LogExecution)")
    @Order(1)
...
//    }
    ...
    @AfterThrowing(pointcut = "@annotation(ru.t1.java.general.annotation.LogException)")
    @Order(0)
    ...
    @AfterReturning(
            pointcut = "@annotation(ru.t1.java.general.annotation.HandlingResult)",
            returning = "result")
