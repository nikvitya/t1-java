...
public class TrackingAspect {
    ...
    @Before("@annotation(ru.t1.java.general.annotation.Track)")
    ...
    @After("@annotation(ru.t1.java.general.annotation.Track)")
    ...
    @Around("@annotation(ru.t1.java.general.annotation.Track)")
